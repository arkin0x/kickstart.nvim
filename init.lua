...
vim.keymap.set('n', '<leader>b', ':b#<CR>', { noremap = true, silent = true, desc = 'Switch to alternate buffer' })
...
require('lazy').setup({
  ...
  { -- Highlight, edit, and navigate code
    ...
    config = function()
      ...
      if ok_new and type(ts.install) == 'function' and type(ts.get_available) == 'function' and type(ts.get_installed) == 'function' then
        ts.install(parsers)
